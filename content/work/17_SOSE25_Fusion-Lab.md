...
{{< figure
    src="/img/works/17_SOSE25_Fusion-Lab/main_page.webp"
    alt="System Demo"
    caption="Figure 1. Multi-Modal RAG System Interface with Cesium 3D Viewer"
...
{{< figure
    src="/img/works/17_SOSE25_Fusion-Lab/graph2.webp"
    alt="Multi-Version BIM Schema"
    caption="Figure 3. Neo4j Graph Schema with Version Evolution Tracking"
    class="mx-auto text-center"
>}}
...
{{< figure
    src="/img/works/17_SOSE25_Fusion-Lab/graph3.webp"
    alt="Knowledge Graph Visualization"
    caption="Figure 4. Knowledge Graph Visualization in Neo4j Browser"
    class="mx-auto text-center"
>}}
